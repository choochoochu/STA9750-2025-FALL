...
```
The table above presents NTAs that fall at or above the 75th percentile for both passed rodent inspections and 311 rodent-related complaint counts in 2024. By restricting attention to neighborhoods that simultaneously rank high on both measures, the table highlights areas where frequent inspection activity co-occurs with high levels of resident reporting. The presence of NTAs with elevated complaint volumes despite a large number of passed inspections suggests that inspection outcomes may not fully reflect underlying rodent pressure, or that reporting behavior differs across neighborhoods. The table underscores potential spatial bias in relying on either passed inspection counts or 311 complaints alone as indicators of rodent prevalence and demonstrates the value of examining their overlap when assessing NTA level rodent activity.
...
```
These areas are plotted above, with NTAs that fall in the top quartile of both passed rodent inspections and 311 complaint volumes highlighted. The axes are shown on a logarithmic scale to accommodate the wide range of inspection and complaint counts across neighborhoods and to make proportional differences more comparable across NTAs. The resulting plot reveals a generally positive association between passed inspections and complaint volume, reflecting shared scaling with neighborhood activity, inspection intensity, and reporting behavior. Notably, even among NTAs with very high numbers of passed inspections, complaint volumes remain elevated
...
The same analysis was conducted at the Community District level. The table above presents Community Districts that fall at or above the 75th percentile for both passed rodent inspections and 311 rodent-related complaint counts in 2024. The presence of Community Districts with elevated complaint volumes despite a large number of passed inspections suggests that inspection outcomes may not fully reflect underlying rodent pressure, or that reporting behavior differs across districts. The table shows potential spatial bias when assessing rodent activity at the Community District scale.
...
```
As with the NTA-level analysis, both axes are displayed on a logarithmic scale to account for the substantial variation in inspection and complaint counts across districts and to facilitate comparison across orders of magnitude. The plot reveals a positive association between passed inspections and complaint volume at the district level. Several districts exhibit high complaint volumes despite large numbers of passed inspections, suggesting that inspection outcomes may not fully capture underlying rodent pressure or that reporting behavior varies systematically across districts. Again, the figure reinforces the impact of spatial scales when assessing rodent activity and highlights how aggregation to the Community District level increases discrepancies between using the 311 complaint data as indicator of rats.
...
In contrast to the highly localized 150-meter analysis, the estimated effect at the NTA scale is negative but not statistically significant (β = −0.369, SE = 0.419, p = 0.378). This result suggests that when inspection outcomes and complaints are aggregated to broader neighborhood boundaries, any localized reduction in complaint activity following a passed inspection is no longer detectable. The loss of statistical significance at this scale highlights how spatial aggregation can obscure short-run, localized responses and underscores the importance of spatial resolution when using 311 complaints as indicators of rodent activity.
...
This also provides justification for the choice of a limited post-inspection window. Following the passed inspection (week 0), average 311 complaint counts drop sharply and then stabilize at a consistently low level, with no evidence of subsequent rebounds or cyclical fluctuations in the weeks that follow. This flattening of complaint activity indicates that the response to a passed inspection is concentrated in the immediate post-inspection period. As a result, extending the analysis to a longer ±8-week window would add little additional information and would not materially change the estimated effects. Instead, a shorter post-inspection window captures the relevant dynamics while avoiding unnecessary noise from more distant time periods.
...
results_all |>
  ...
  kable_styling(full_width = FALSE, bootstrap_options = c("striped", "hover"))
```
The table reports the estimated percent change in weekly 311 rodent complaint counts following a passed inspection, along with 95% confidence intervals, across three spatial scales. At the most localized level—a 150-meter radius around each inspection—the estimated effect is a large and statistically significant reduction in complaints (−67.9%), with a narrow confidence interval that lies entirely below zero. This indicates a consistent short-run decline in complaint activity in the immediate vicinity of a passed inspection.
